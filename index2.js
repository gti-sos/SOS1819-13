...
client.connect(err => {
 ...
 var newGasIncreases = [{
    ...
    // POST /gas-increases
    app.post("/gas-increases", (req, res) => {
    var newGas = req.body;
    var coincide = false;
    var i = 0;
        ...
        app.post("/gas-increases/:year/:province", (req,res)=>{
            res.sendStatus(405);
        });
        
    // DELETE /gas-increases
     app.delete("/gas-increases", (req, res) => {
    ...
    app.get("/gas-increases/:year/:province", (req, res) => {
    ...
    app.put("/gas-increases/:year/:province", (req, res) => {
        var year = req.params.year;
        var province = req.params.province;
    ...
    app.delete("/gas-increases/:year/:province", (req,res)=>{
        var year = req.params.year;
        var province = req.params.province;
        var found = false;
        var updatedgasIncreases = [];
